...
class DataConnectionChecker {
  ...
  static final List<AddressCheckOptions> defaultAddressed = List.unmodifiable([
    AddressCheckOptions(
  ...
  List<AddressCheckOptions> addresses = defaultAddressed;
